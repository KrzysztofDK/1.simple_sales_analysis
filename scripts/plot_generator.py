...
def run_all_visualizations(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        plt.savefig(os.path.join('images', 'sales_count_histplot.png'), dpi=300, bbox_inches='tight')
        plt.close()

        plt.figure(figsize=(10, 6))
        sns.scatterplot(x='QUANTITYORDERED', y='SALES', data=df)
        plt.savefig(os.path.join('images', 'quanttityordered_scatterplot.png'), dpi=300, bbox_inches='tight')
        plt.close()

        plt.figure(figsize=(10, 6))
        sns.boxplot(x='DEALSIZE', y='SALES', data=df)
        plt.savefig(os.path.join('images', 'dealsize_sale_boxplot.png'), dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.savefig(os.path.join('images', 'month_sales_bar.png'), dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.gca().yaxis.set_major_formatter(formatter)
        plt.savefig(os.path.join('images', 'productline_sales_bar.png'), dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.gca().yaxis.set_major_formatter(formatter)
        plt.savefig(os.path.join('images', 'country_sales_bar.png'), dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join('images', 'customer_sales_quantity_bar.png'), dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join('images', 'sales_by_month_per_year_plot.png'), dpi=300, bbox_inches='tight')
        plt.close()
